...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
alert('acount1 : user - gg,pin-1111 ,acount2 : user - dg, pin - 2222');
// BANKIST APP
...
const formatMovementDate = function (date, locale) {
  ...
  const daysPasssed = calcDayPassed(new Date(), date);
  console.log(daysPasssed);
  if (daysPasssed === 0) return 'Today';
  if (daysPasssed === 1) return 'Yestarday';
